...
#define EP_CTRL     0x06u            // Cfg Control pipe for this ep
#define EP_OUT      0x0Cu            // Cfg OUT only pipe for this ep
#define EP_IN       0x0Au            // Cfg IN only pipe for this ep
#define EP_OUT_IN   0x0Eu            // Cfg both OUT & IN pipes for this ep
#define HSHK_EN     0x10u            // Enable handshake packet
...
#define EP00_OUT    (0x00u<<3)|(OUT<<2)
#define EP00_IN     (0x00u<<3)|(IN<<2)
